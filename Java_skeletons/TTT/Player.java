...
public class Player {
    ...
    public GameState play(final GameState gameState, final Deadline deadline) {
        ...
        return nextStates.elementAt(minmax(gameState, nextStates, 4, alpha, beta, gameState.getNextPlayer()));
    }
    ...
    public int eval(GameState gameState, int player) {
        ...
        for(int i = 0; i < n; i++) {
            ...
            diag += (gameState.at(i, i) == player) ? 1 : 0;
            diag += (gameState.at(n-i, n-i) == player) ? 1 : 0;
        }
        return row + col + diag;
    }
}
